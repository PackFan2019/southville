...
WHERE NAME = N'usp_GetItemsByLevel'
AND TYPE='P'
)
DROP PROCEDURE usp_GetItemsByLevel
GO

CREATE PROCEDURE usp_GetItemsByLevel
(
...
--EXEC usp_GetItemsByLevel
--@Level='Grade 1',
--@Currency='Z-US$',
--@Class_ID='MF',
--@UofM='Unit'--
--@Item_Number='TUITION FEE'


GO

GRANT EXECUTE ON usp_GetItemsByLevel TO DYNGRP;
