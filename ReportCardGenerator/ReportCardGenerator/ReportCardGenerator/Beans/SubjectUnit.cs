    ...
    class SubjectUnit
    {
        ...
        public static void loadUnit()
        {
            try
            {
                ...
                HashTables.Grade1.Add("COMP", 0.2);
                HashTables.Grade1.Add("MAPE", 0.6);
                HashTables.Grade1.Add("MUSI", 0.2);
                HashTables.Grade1.Add("ARTS", 0.2);
                HashTables.Grade1.Add("PHED", 0.2);
                HashTables.Grade1.Add("RVED", 0.2);
                ...
                HashTables.Grade2.Add("COMP", 0.2);
                HashTables.Grade2.Add("MAPE", 0.6);
                HashTables.Grade2.Add("MUSI", 0.2);
                HashTables.Grade2.Add("ARTS", 0.2);
                HashTables.Grade2.Add("PHED", 0.2);
                HashTables.Grade2.Add("RVED", 0.2);
                ...
                HashTables.Grade6.Add("SLGE", 1);
                HashTables.Grade6.Add("HIST", 0);
                HashTables.Grade6.Add("LEAD", 1);
                HashTables.Grade6.Add("FILI", 0.25);
                HashTables.Grade6.Add("COMP", 0.25);
                HashTables.Grade6.Add("MAPE", 0.75);
                HashTables.Grade6.Add("MUSI", 0.25);
                HashTables.Grade6.Add("ARTS", 0.25);
                HashTables.Grade6.Add("PHED", 0.25);
                HashTables.Grade6.Add("FORE", 0.25);
                HashTables.Grade6.Add("HOME", 0.25);
                HashTables.Grade6.Add("RVED", 0.25);
                ...
                HashTables.Grade7.Add("SLGE", 1);
                HashTables.Grade7.Add("HIST", 0);
                HashTables.Grade7.Add("LEAD", 1);
                HashTables.Grade7.Add("FILI", 0.25);
                HashTables.Grade7.Add("COMP", 0.25);
                HashTables.Grade7.Add("MAPE", 0.75);
                HashTables.Grade7.Add("MUSI", 0.25);
                HashTables.Grade7.Add("ARTS", 0.25);
                HashTables.Grade7.Add("PHED", 0.25);
                HashTables.Grade7.Add("FORE", 0.25);
                HashTables.Grade7.Add("HOME", 0.25);
                HashTables.Grade7.Add("RVED", 0.25);
                HashTables.Grade7.Add("DEPO", 0);
                ...
                HashTables.HS1.Add("SLGE", 1.05);
                HashTables.HS1.Add("HIST", 0);
                ...
                HashTables.HS1.Add("RVED", 0.3);
                HashTables.HS1.Add("LANG", 0.2);
                ...
                HashTables.HS2.Add("SLGE", 1.05);
                HashTables.HS2.Add("HIST", 0);
                ...
                HashTables.HS3.Add("SLGE", 1.05);
                HashTables.HS3.Add("HIST", 0);
                ...
                HashTables.HS4.Add("SLGE", 1.05);
                HashTables.HS4.Add("HIST", 0);
